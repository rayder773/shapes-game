...
export function getGameplaySettingsValues(profile: GameplayProfile): GameplaySettingsValues {
  return {
    ...
    coinSpawnChancePercent: Math.round(profile.coinSpawnChance * 100),
    lifePickupLifetimeSeconds: profile.lifePickupLifetimeSeconds,
    coinPickupLifetimeSeconds: profile.coinPickupLifetimeSeconds,
...
export function resolveGameplayProfile(
  ...
  return {
    ...
    coinSpawnChance: values.coinSpawnChancePercent / 100,
    lifePickupLifetimeSeconds: values.lifePickupLifetimeSeconds,
    coinPickupLifetimeSeconds: values.coinPickupLifetimeSeconds,
